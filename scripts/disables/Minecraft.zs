...
//val BedrockDust = <RotaryCraft:rotarycraft_item_powders:4>; добавить слитки бедрока их екстраутилсов
//val Lens = <RotaryCraft:rotarycraft_item_misccraft:1>;

val Bowstring = <minecraft:string>;
...
[RedAlloyRod, RSDust, RedAlloyRod]]);
