...
val AlGear = <appliedenergistics2:item.ItemMultiMaterial:22>;
val DiamondGear = <BuildCraft|Silicon:redstoneChipset:4>;
val SSteelGear = <appliedenergistics2:item.ItemMultiMaterial:23>;
val GoldGear = <BuildCraft|Silicon:redstoneChipset:2>;
val TitaniumGear = <ore:circuitUltimate>;
val SteelGear = <ore:circuitAdvanced>;
...
val PaperStack = <minecraft:paper>;
...
[DiamondCircuit, GoldChip, DiamondCircuit],
