...
var blockSteel = <Railcraft:cube:2>;
...
// --- Fluix Glass Cable
recipes.addShaped(FluixGlassCable * 16, [
[CertusRod, FluixDust, CertusRod],
[QuartzFiber, QuartzFiber, QuartzFiber],
[CertusRod, FluixDust, CertusRod]]);

// --- Fluix Covered Cable
recipes.addShaped(FluixCoveredC * 16, [
...
// --- Advanced Card
recipes.addShaped(<appliedenergistics2:item.ItemMultiMaterial:28>*4, [
[<ore:platePlatinum>, AlPlate, null],
[<ore:plateRedAlloy>, CertusCircuit, AlPlate],
[<ore:platePlatinum>, AlPlate, null]]);

// --- Basic Card
recipes.addShaped(<appliedenergistics2:item.ItemMultiMaterial:25>*4, [
[<ore:plateGold>, AlPlate, null],
[<ore:plateRedAlloy>, CertusCircuit, AlPlate],
[<ore:plateGold>, AlPlate, null]]);

// --- Blank Pattern
recipes.addShaped(Pattern*4, [
...
// --- Capacity Card
recipes.addShapeless(<appliedenergistics2:item.ItemMultiMaterial:27>*4, [<appliedenergistics2:item.ItemMultiMaterial:25>, <appliedenergistics2:item.ItemMultiMaterial:35>, <appliedenergistics2:item.ItemMultiMaterial:35>, CCertusQuartz]);

// --- Crafting Card
recipes.addShapeless(<appliedenergistics2:item.ItemMultiMaterial:53>*2, [<appliedenergistics2:item.ItemMultiMaterial:25>, <appliedenergistics2:item.ItemMultiMaterial:35>, <appliedenergistics2:item.ItemMultiMaterial:35>, <ore:craftingWorkBench>]);

// --- Redstone Card
recipes.addShapeless(<appliedenergistics2:item.ItemMultiMaterial:26>*2, [<appliedenergistics2:item.ItemMultiMaterial:25>, <ore:craftingRedstoneTorch>, <ore:craftingRedstoneTorch>, CertusCircuit]);

// --- Fuzzy Card
recipes.addShapeless(<appliedenergistics2:item.ItemMultiMaterial:29>*2, [<appliedenergistics2:item.ItemMultiMaterial:28>, DiamondCircuit, GoldCircuit, CertusCircuit]);

// --- Inverter Card
recipes.addShapeless(<appliedenergistics2:item.ItemMultiMaterial:31>*2, [<appliedenergistics2:item.ItemMultiMaterial:28>, <IC2:upgradeModule:5>, <IC2:upgradeModule:5>, CertusCircuit]);

// --- Acceleration Card
recipes.addShapeless(<appliedenergistics2:item.ItemMultiMaterial:30>*2, [<appliedenergistics2:item.ItemMultiMaterial:28>, DiamondCircuit, GoldCircuit, FluixCrystal]);
...
// --- ME Export Bus
recipes.addShaped(<appliedenergistics2:item.ItemMultiPart:260>*4, [
...
// --- ME Import Bus
recipes.addShaped(<appliedenergistics2:item.ItemMultiPart:240>*4, [
...
// --- Illuminated Panel
recipes.addShaped(<appliedenergistics2:item.ItemMultiPart:180>*4, [
...
// --- ME Toggle Bus
recipes.addShaped(<appliedenergistics2:item.ItemMultiPart:80>*4, [
...
// --- Quartz Glass
AlloySmelter.addRecipe(<appliedenergistics2:tile.BlockQuartzGlass> * 8, <minecraft:glass> * 4, <gregtech:gt.metaitem.01:2516> * 4, 400, 16);
...
// --- Seeds
ChemicalReactor.addRecipe(<appliedenergistics2:item.ItemCrystalSeed> * 32, <gregtech:gt.metaitem.01:2516>, <minecraft:sand>, 100);
ChemicalReactor.addRecipe(<appliedenergistics2:item.ItemCrystalSeed> * 32, <gregtech:gt.metaitem.01:2516>, <minecraft:sand:1>, 100);
// -
ChemicalReactor.addRecipe(<appliedenergistics2:item.ItemCrystalSeed:600> * 32, <gregtech:gt.metaitem.01:2522>, <minecraft:sand>, 100);
ChemicalReactor.addRecipe(<appliedenergistics2:item.ItemCrystalSeed:600> * 32, <gregtech:gt.metaitem.01:2522>, <minecraft:sand:1>, 100);
// -
ChemicalReactor.addRecipe(<appliedenergistics2:item.ItemCrystalSeed:1200> * 32, <appliedenergistics2:item.ItemMultiMaterial:8>, <minecraft:sand>, 100);
ChemicalReactor.addRecipe(<appliedenergistics2:item.ItemCrystalSeed:1200> * 32, <appliedenergistics2:item.ItemMultiMaterial:8>, <minecraft:sand:1>, 100);
...
// --- Fluix Dust
Macerator.addRecipe(FluixDust * 32, <appliedenergistics2:tile.BlockFluix>);
...
//Quartz Fiber
Wiremill.addRecipe(<appliedenergistics2:item.ItemMultiPart:140>*2, <gregtech:gt.metaitem.01:23516> * 2, 200, 128);
// -
Wiremill.addRecipe(<appliedenergistics2:item.ItemMultiPart:140>*8, <gregtech:gt.metaitem.01:23522> * 8, 200, 128);
// -
Wiremill.addRecipe(<appliedenergistics2:item.ItemMultiPart:140>*4, <gregtech:gt.metaitem.01:23523>  * 4, 200, 128);


// --- AE2 Presses ---

// Silicon Press
PrecisionLaser.addRecipe(pressSilicon, lensGlass * 0, blockSteel, 12000, 120);
PrecisionLaser.addRecipe(pressSilicon, lensOrdo * 0, blockSteel, 12000, 120);
PrecisionLaser.addRecipe(pressSilicon, lensDiamond * 0, blockSteel, 12000, 120);
PrecisionLaser.addRecipe(pressSilicon, lensDilithium * 0, blockSteel, 12000, 120);
// Logic Press
PrecisionLaser.addRecipe(pressLogic, lensGreenSapphire * 0, blockSteel, 12000, 120);
PrecisionLaser.addRecipe(pressLogic, lensEmerald * 0, blockSteel, 12000, 120);
PrecisionLaser.addRecipe(pressLogic, lensTerra * 0, blockSteel, 12000, 120);
PrecisionLaser.addRecipe(pressLogic, lensEmerald * 0, blockSteel, 2000, 1920);
PrecisionLaser.addRecipe(pressLogic, lensTerra * 0, blockSteel, 2000, 1920);
// Engineering Press
PrecisionLaser.addRecipe(pressEngineering, lensAer * 0, blockSteel, 12000, 120);
PrecisionLaser.addRecipe(pressEngineering, lensYellowGarnet * 0, blockSteel, 12000, 120);
// Calculation Press
PrecisionLaser.addRecipe(pressCalculation, lensOpal * 0, blockSteel, 12000, 120);
PrecisionLaser.addRecipe(pressCalculation, lensSapphire * 0, blockSteel, 12000, 120);
PrecisionLaser.addRecipe(pressCalculation, lensAqua * 0, blockSteel, 12000, 120);
PrecisionLaser.addRecipe(pressCalculation, lensBlueTopaz * 0, blockSteel, 12000, 120);
