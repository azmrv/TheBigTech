...
[<GalacticraftCore:item.basicItem:9>, <GalacticraftCore:item.battery:*>, <ProjRed|Illumination:projectred.illumination.lamp>],
[<GalacticraftCore:item.basicItem:9>, <gregtech:gt.blockmachines:1246>, <GalacticraftCore:item.basicItem:9>]]);
...
[null, <ProjRed|Illumination:projectred.illumination.lamp:14>, null],
...
[AlFoil, silkWoven, AlFoil],
[silkWoven, <ore:plateRubber>, silkWoven],
[AlFoil, silkWoven, AlFoil]]);
...
Macerator.addRecipe(<GalacticraftCore:item.meteoricIronRaw> * 8, <GalacticraftCore:tile.fallenMeteor>);
